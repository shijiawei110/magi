package com.sjw.magiconf.client.processor;
...
public class DefaultClientProcessor implements ReqCmdProcessor {
    ...
    public CmdPackage executeRequest(Channel channel, CmdPackage requset) {
        log.info("magiconf client default do a request -> addr={} , request={}", ChannelHelper.getRemoteAddr(channel), requset.toString());
