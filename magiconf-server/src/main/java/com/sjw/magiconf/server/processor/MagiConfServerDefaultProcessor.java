...
/**
 * @author shijiawei
 * @version MagiConfServerDefaultProcessor.java, v 0.1
 * @date 2019/2/21
 * 测试处理器
 */
@Slf4j
public class MagiConfServerDefaultProcessor implements ReqCmdProcessor {

    @Override
    public CmdPackage executeRequest(Channel channel, CmdPackage requset) {
        return CmdPackage.successRes(requset.getSn(), "magiconf default processor succeed");
    }
}
